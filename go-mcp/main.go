// Command WorldCupQualification-mcp is an MCP server exposing the WorldCupQualification
// SDK as MCP tools.
//
// Two tools are registered:
//
//	WorldCupQualification_list  — list records of an entity
//	WorldCupQualification_load  — load a single record of an entity
//
