...
class MatchEntity
  ...
  #
  # @param reqmatch [MatchListMatch, Hash, nil] match filter (any subset of
  #   Match fields); defaults to nil, treated as an empty match that lists all.
