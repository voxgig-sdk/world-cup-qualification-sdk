...
// WorldCupQualification SDK utility type

class WorldCupQualificationUtility
{
    ...
    public static function copy(WorldCupQualificationUtility $src): WorldCupQualificationUtility
    {
        $u = new WorldCupQualificationUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
