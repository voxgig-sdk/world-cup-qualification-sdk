...
// WorldCupQualification SDK telemetry feature
...
class WorldCupQualificationTelemetryFeature extends WorldCupQualificationBaseFeature
{
    ...
    private function _close(WorldCupQualificationContext $ctx, bool $ok): void
    {
