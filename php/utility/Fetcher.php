...
// WorldCupQualification SDK utility: fetcher

class WorldCupQualificationFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; WorldCupQualificationSDK/1.0)';
    ...
    public static function call(WorldCupQualificationContext $ctx, string $fullurl, array $fetchdef): array
    {
