...
describe("MatchDirect", function()
  it("should direct-list-match", function()
    local setup = match_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-match", setup.live and "live" or "unit")
