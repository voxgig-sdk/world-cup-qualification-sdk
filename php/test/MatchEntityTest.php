...
class MatchEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set WORLDCUPQUALIFICATION_TEST_MATCH_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function match_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("WORLDCUPQUALIFICATION_TEST_MATCH_ENTID");
