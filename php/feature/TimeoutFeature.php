...
// WorldCupQualification SDK timeout feature
...
class WorldCupQualificationTimeoutFeature extends WorldCupQualificationBaseFeature
{
    ...
    private function _with_timeout(WorldCupQualificationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(WorldCupQualificationContext $_ctx, float $ms): void
    {
        $client = $this->client;
