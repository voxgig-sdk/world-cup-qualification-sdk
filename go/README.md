...
The Golang SDK for the WorldCupQualification API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/world-cup-qualification-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/world-cup-qualification-sdk=../path/to/github.com/voxgig-sdk/world-cup-qualification-sdk
```
...
```
github.com/voxgig-sdk/world-cup-qualification-sdk/
...
The root package (`github.com/voxgig-sdk/world-cup-qualification-sdk`) re-exports everything needed
