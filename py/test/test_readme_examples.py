# WorldCupQualification SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions WorldCupQualificationSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both WorldCupQualificationSDK(...) and WorldCupQualificationSDK.test(...) become
#      WorldCupQualificationSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "worldcupqualification_sdk"
_SDK_CLASS = "WorldCupQualificationSDK"
