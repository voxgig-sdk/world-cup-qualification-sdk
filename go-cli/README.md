...
AQL-driven CLI and REPL for the WorldCupQualification SDK. Positional arguments are
...
```sh
go build -o world-cup-qualification-cli ./...
```
...
./world-cup-qualification-cli load 1 competition
./world-cup-qualification-cli load '{id:1}' competition
