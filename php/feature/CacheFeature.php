...
// WorldCupQualification SDK cache feature
...
class WorldCupQualificationCacheFeature extends WorldCupQualificationBaseFeature
{
    ...
    private function _through(WorldCupQualificationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
