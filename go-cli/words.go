...
func registerSDKWords(r *eng.Registry, client *sdk.WorldCupQualificationSDK) {
...
func runOp(client *sdk.WorldCupQualificationSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
