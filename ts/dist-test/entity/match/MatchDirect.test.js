...
(0, node_test_1.describe)('MatchDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-match', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-match', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["competition01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['WORLD_CUP_QUALIFICATION_TEST_MATCH_ENTID'];
...
//# sourceMappingURL=MatchDirect.test.js.map