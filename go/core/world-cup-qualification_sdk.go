...
type WorldCupQualificationSDK struct {
	Mode     string
...
func (sdk *WorldCupQualificationSDK) OptionsMap() map[string]any {
...
func (sdk *WorldCupQualificationSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *WorldCupQualificationSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *WorldCupQualificationSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WorldCupQualificationSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *WorldCupQualificationSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *WorldCupQualificationSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("WorldCupQualificationSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *WorldCupQualificationSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WorldCupQualificationSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("WorldCupQualificationSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *WorldCupQualificationSDK {
	...
	sdk := NewWorldCupQualificationSDK(sdkopts)
	sdk.Mode = "test"
