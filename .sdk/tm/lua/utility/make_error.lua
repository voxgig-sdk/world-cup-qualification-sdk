...
local function make_error_util(ctx, err)
  ...
  local msg = "WorldCupQualificationSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = WorldCupQualificationError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == WorldCupQualificationError then
