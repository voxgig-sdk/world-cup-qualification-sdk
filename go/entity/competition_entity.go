...
type CompetitionEntity struct {
	name    string
	client  *core.WorldCupQualificationSDK
...
func NewCompetitionEntity(client *core.WorldCupQualificationSDK, entopts map[string]any) *CompetitionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CompetitionEntity) GetName() string { return e.name }
...
func (e *CompetitionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CompetitionEntity) Deleted() bool {
	return e.deleted
}


func (e *CompetitionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCompetitionEntity(e.client, opts)
}

func (e *CompetitionEntity) Data(args ...any) any {
...
func (e *CompetitionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Competition; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CompetitionEntity) DataTyped(data ...Competition) Competition {
	if len(data) > 0 {
		return typedFrom[Competition](e.Data(asMap(data[0])))
	}
	return typedFrom[Competition](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Competition (all fields
// optional at the wire level).
func (e *CompetitionEntity) MatchTyped(match ...Competition) Competition {
	if len(match) > 0 {
		return typedFrom[Competition](e.Match(asMap(match[0])))
	}
	return typedFrom[Competition](e.Match())
}
...
func (e *CompetitionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CompetitionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CompetitionLoadMatch and returns an Competition. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CompetitionEntity) LoadTyped(reqmatch CompetitionLoadMatch, ctrl map[string]any) (Competition, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Competition{}, err
	}
	return typedFrom[Competition](res), nil
}




func (e *CompetitionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// CompetitionListMatch and returns []Competition. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CompetitionEntity) ListTyped(reqmatch CompetitionListMatch, ctrl map[string]any) ([]Competition, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Competition](res), nil
}



func (e *CompetitionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CompetitionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CompetitionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CompetitionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
