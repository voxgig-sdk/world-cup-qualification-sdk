...
function runner.env_override(m)
  local live = runner.getenv("WORLDCUPQUALIFICATION_TEST_LIVE")
  local override = runner.getenv("WORLDCUPQUALIFICATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("WORLDCUPQUALIFICATION_TEST_EXPLAIN")
