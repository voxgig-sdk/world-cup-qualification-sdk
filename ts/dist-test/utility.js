...
function envOverride(m) {
    if ('TRUE' === process.env.WORLD_CUP_QUALIFICATION_TEST_LIVE ||
        'TRUE' === process.env.WORLD_CUP_QUALIFICATION_TEST_OVERRIDE) {
    ...
    m.WORLD_CUP_QUALIFICATION_TEST_EXPLAIN = process.env.WORLD_CUP_QUALIFICATION_TEST_EXPLAIN || m.WORLD_CUP_QUALIFICATION_TEST_EXPLAIN;
    return m;
}
