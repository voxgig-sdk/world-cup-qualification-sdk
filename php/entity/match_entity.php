...
// WorldCupQualification SDK Match entity
...
class MatchEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MatchEntity($this->_client, $opts);
    }

    /**
     * @param Match|array $args Match data (assoc-array) to store.
     */
    ...
    /**
     * @return Match|array The current Match data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Match fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Match fields).
     */
     ...
     *
     * @param MatchListMatch|array|null $reqmatch Match filter (any subset
     *   of Match fields) as an assoc-array; MatchListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Match[]|array A list of Match items as assoc-arrays at
