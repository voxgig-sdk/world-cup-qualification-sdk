...
describe("TeamEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set WORLDCUPQUALIFICATION_TEST_TEAM_ENTID JSON to run live")
      return
    end
...
function team_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("WORLDCUPQUALIFICATION_TEST_TEAM_ENTID")
