...
// WorldCupQualification SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (WorldCupQualificationSDK::test)
...
{
    private const SDK_CLASS = 'WorldCupQualificationSDK';
    ...
    private const SDK_BASE = 'worldcupqualification_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../worldcupqualification_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
