...
type Args struct {
	Entity string         `json:"entity" jsonschema:"competition | match | standing | team"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.WorldCupQualificationSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "world-cup-qualification_list",
		Description: "List records from WorldCupQualification. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "world-cup-qualification_load",
		Description: "Load a single record from WorldCupQualification. " +
...
func runOp(client *sdk.WorldCupQualificationSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.WorldCupQualificationSDK, name string) (sdk.WorldCupQualificationEntity, error) {
	switch strings.ToLower(name) {
	case "competition":
		return client.Competition(nil), nil
	case "match":
		return client.Match(nil), nil
	case "standing":
