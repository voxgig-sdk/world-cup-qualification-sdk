...
// WorldCupQualification SDK pipeline test
//
...
{
    private static function utility(): WorldCupQualificationUtility
    {
        return new WorldCupQualificationUtility();
    }
    ...
    private static function ctx(array $over = []): WorldCupQualificationContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new WorldCupQualificationContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new WorldCupQualificationOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof WorldCupQualificationError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new WorldCupQualificationOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = WorldCupQualificationMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new WorldCupQualificationOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = WorldCupQualificationMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new WorldCupQualificationOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = WorldCupQualificationMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new WorldCupQualificationSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = WorldCupQualificationMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new WorldCupQualificationResponse([]),
            'result' => new WorldCupQualificationResult([]),
        ]);
        [, $err] = WorldCupQualificationMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new WorldCupQualificationSpec([]),
            'response' => null,
            'result' => new WorldCupQualificationResult([]),
        ]);
        [, $err] = WorldCupQualificationMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new WorldCupQualificationSpec(['step' => 's']),
            'response' => new WorldCupQualificationResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new WorldCupQualificationResult([]),
        ]);
        [, $err] = WorldCupQualificationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new WorldCupQualificationSpec(['step' => 's']),
            'response' => new WorldCupQualificationResponse(self::resp(200, ['v' => 1])),
            'result' => new WorldCupQualificationResult([]),
        ]);
        [, $err] = WorldCupQualificationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new WorldCupQualificationSpec(['step' => 's']),
            'response' => new WorldCupQualificationResponse(self::resp(200, ['v' => 2])),
            'result' => new WorldCupQualificationResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        WorldCupQualificationMakeResponse::call($ctx);
    ...
    {
        $preset = new WorldCupQualificationResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new WorldCupQualificationSpec([]),
            'response' => new WorldCupQualificationResponse([]),
            'result' => new WorldCupQualificationResult([]),
        ...
        [$got, $err] = WorldCupQualificationMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new WorldCupQualificationResult([])]);
        [, $err] = WorldCupQualificationMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new WorldCupQualificationSpec([]), 'result' => null]);
        [, $err] = WorldCupQualificationMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new WorldCupQualificationSpec(['step' => 's']),
            'result' => new WorldCupQualificationResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new WorldCupQualificationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = WorldCupQualificationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new WorldCupQualificationSpec(['step' => 's']),
            'result' => new WorldCupQualificationResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new WorldCupQualificationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = WorldCupQualificationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new WorldCupQualificationResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new WorldCupQualificationSpec([]),
            'result' => new WorldCupQualificationResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = WorldCupQualificationMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = WorldCupQualificationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new WorldCupQualificationError('boom', 'boom');
        $utility->fetcher = function (WorldCupQualificationContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new WorldCupQualificationSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = WorldCupQualificationMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (WorldCupQualificationContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = WorldCupQualificationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(WorldCupQualificationResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        WorldCupQualificationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (WorldCupQualificationContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new WorldCupQualificationSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = WorldCupQualificationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new WorldCupQualificationResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new WorldCupQualificationSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = WorldCupQualificationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = WorldCupQualificationMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = WorldCupQualificationMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new WorldCupQualificationResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, WorldCupQualificationDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new WorldCupQualificationResult(['ok' => false])]);
        $this->expectException(WorldCupQualificationError::class);
        WorldCupQualificationDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new WorldCupQualificationResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', WorldCupQualificationMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        WorldCupQualificationMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new WorldCupQualificationBaseFeature();
        $b = new WorldCupQualificationBaseFeature();
        WorldCupQualificationFeatureAdd::call($ctx, $a);
        WorldCupQualificationFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): WorldCupQualificationBaseFeature
    {
        $f = new WorldCupQualificationBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        WorldCupQualificationFeatureAdd::call($ctx, self::named_feature('a'));
        WorldCupQualificationFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        WorldCupQualificationFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        WorldCupQualificationFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        WorldCupQualificationFeatureAdd::call($ctx, $replace);
        ...
        WorldCupQualificationFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): WorldCupQualificationContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new WorldCupQualificationSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = WorldCupQualificationPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        WorldCupQualificationPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new WorldCupQualificationResponse(['headers' => null]),
            'result' => new WorldCupQualificationResult([]),
        ]);
        WorldCupQualificationResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        WorldCupQualificationResultBody::call($ctx);
