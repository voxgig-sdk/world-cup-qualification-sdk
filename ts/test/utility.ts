...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.WORLDCUPQUALIFICATION_TEST_LIVE ||
    'TRUE' === process.env.WORLDCUPQUALIFICATION_TEST_OVERRIDE
  ) {
  ...
  m.WORLDCUPQUALIFICATION_TEST_EXPLAIN = process.env.WORLDCUPQUALIFICATION_TEST_EXPLAIN || m.WORLDCUPQUALIFICATION_TEST_EXPLAIN
