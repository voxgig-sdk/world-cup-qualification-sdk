...
// WorldCupQualification SDK utility: graphql
//
...
class WorldCupQualificationGraphql
{
    ...
    // equivalent.
    public static function body(WorldCupQualificationContext $ctx): mixed
    {
    ...
    public static function errors(WorldCupQualificationContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
