...
func NewMatchEntity(client *core.WorldCupQualificationSDK, entopts map[string]any) *MatchEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MatchEntity) GetName() string { return e.name }
...
func (e *MatchEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MatchEntity) Deleted() bool {
	return e.deleted
}


func (e *MatchEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMatchEntity(e.client, opts)
}

func (e *MatchEntity) Data(args ...any) any {
...
func (e *MatchEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *MatchEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MatchEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *MatchEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *MatchEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MatchEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MatchEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MatchEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
