# WorldCupQualification SDK feature corpus test
#
...
def _client(kase):
    ...
    WorldCupQualificationSDK(...), not WorldCupQualificationSDK.test(...): the `test` feature is
    ...
    return WorldCupQualificationSDK(opts)
