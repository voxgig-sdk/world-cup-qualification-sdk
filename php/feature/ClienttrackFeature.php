...
// WorldCupQualification SDK clienttrack feature
...
class WorldCupQualificationClienttrackFeature extends WorldCupQualificationBaseFeature
{
    ...
    public function PostConstruct(WorldCupQualificationContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'WorldCupQualification-SDK';
