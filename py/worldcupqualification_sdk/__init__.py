...
from worldcupqualification_sdk.utility import register

# Load features
from worldcupqualification_sdk.feature.base_feature import WorldCupQualificationBaseFeature
from worldcupqualification_sdk.features import _has_feature, _make_feature
...
class WorldCupQualificationSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = WorldCupQualificationUtility()
    ...
    def get_utility(self):
        return WorldCupQualificationUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("WorldCupQualificationSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Competition(self, data=None) -> "CompetitionEntity":
        ...
        from worldcupqualification_sdk.entity.competition_entity import CompetitionEntity
    ...
    def Match(self, data=None) -> "MatchEntity":
        ...
        from worldcupqualification_sdk.entity.match_entity import MatchEntity
    ...
    def Standing(self, data=None) -> "StandingEntity":
        ...
        from worldcupqualification_sdk.entity.standing_entity import StandingEntity
        return StandingEntity(self, data)


    def Team(self, data=None) -> "TeamEntity":
        """Entity factory: client.Team().list() / client.Team().load({"id": ...})."""
        from worldcupqualification_sdk.entity.team_entity import TeamEntity
