...
// WorldCupQualification SDK rbac feature
...
class WorldCupQualificationRbacFeature extends WorldCupQualificationBaseFeature
{
    ...
    private function _required(WorldCupQualificationContext $ctx): ?string
    {
    ...
    private function _reject(WorldCupQualificationContext $ctx, string $required): void
    {
    ...
    private function _track(WorldCupQualificationContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
