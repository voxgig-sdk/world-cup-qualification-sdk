...
|---|---|---|
| `ts/` | @voxgig-sdk/world-cup-qualification-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/world-cup-qualification-sdk \
      --repository voxgig-sdk/world-cup-qualification-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/world-cup-qualification-sdk` shows it, and
`npm trust revoke @voxgig-sdk/world-cup-qualification-sdk --id=<id>` removes it.
