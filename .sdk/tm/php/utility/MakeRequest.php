...
// WorldCupQualification SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class WorldCupQualificationMakeRequest
{
    public static function call(WorldCupQualificationContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new WorldCupQualificationResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new WorldCupQualificationResponse($fetched);
        } else {
