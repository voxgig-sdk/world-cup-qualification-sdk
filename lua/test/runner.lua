...
function runner.env_override(m)
  local live = runner.getenv("WORLD_CUP_QUALIFICATION_TEST_LIVE")
  local override = runner.getenv("WORLD_CUP_QUALIFICATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("WORLD_CUP_QUALIFICATION_TEST_EXPLAIN")
