...
// WorldCupQualification SDK audit feature
...
class WorldCupQualificationAuditFeature extends WorldCupQualificationBaseFeature
{
    ...
    private function _emit(WorldCupQualificationContext $ctx, string $outcome): void
    {
