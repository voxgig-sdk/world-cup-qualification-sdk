...
const testSeed = `map[string]any{"entity": map[string]any{"competition": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "match": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "standing": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "team": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
