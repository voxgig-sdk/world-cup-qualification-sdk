...
class TeamEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set WORLDCUPQUALIFICATION_TEST_TEAM_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def team_basic_setup(extra)
  ...
  entid_env_raw = ENV["WORLDCUPQUALIFICATION_TEST_TEAM_ENTID"]
