...
from worldcupqualification_sdk.core.helpers import get_ctx_prop, to_map
...
class WorldCupQualificationContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = WorldCupQualificationControl()
        ...
        if isinstance(sp, WorldCupQualificationSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, WorldCupQualificationResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, WorldCupQualificationResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return WorldCupQualificationOperation({})
        ...
        op = WorldCupQualificationOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return WorldCupQualificationError(code, msg, self)
