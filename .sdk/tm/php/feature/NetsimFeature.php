...
// WorldCupQualification SDK netsim feature
...
class WorldCupQualificationNetsimFeature extends WorldCupQualificationBaseFeature
{
    ...
    private function _simulate(WorldCupQualificationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(WorldCupQualificationContext $ctx, array $applied): void
    {
        $client = $this->client;
