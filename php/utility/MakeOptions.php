...
// WorldCupQualification SDK utility: make_options

class WorldCupQualificationMakeOptions
{
    ...
    public static function call(WorldCupQualificationContext $ctx): array
    {
        ...
        //
        // `WorldCupQualificationSchema::optspec()` is built from the model:
        ...
        $optspec = WorldCupQualificationSchema::optspec();
