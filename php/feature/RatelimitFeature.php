...
// WorldCupQualification SDK ratelimit feature
...
class WorldCupQualificationRatelimitFeature extends WorldCupQualificationBaseFeature
{
    ...
    private function _acquire(WorldCupQualificationContext $ctx): void
    {
    ...
    private function _track(WorldCupQualificationContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
