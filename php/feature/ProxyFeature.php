...
// WorldCupQualification SDK proxy feature
...
class WorldCupQualificationProxyFeature extends WorldCupQualificationBaseFeature
{
    ...
    public function init(WorldCupQualificationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (WorldCupQualificationContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
