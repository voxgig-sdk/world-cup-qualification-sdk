...
#      offline in seeded test mode (WorldCupQualificationSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "WorldCupQualification_sdk.rb")
  SDK_CLASS = "WorldCupQualificationSDK"
  ...
  SDK_BASE = "WorldCupQualification_sdk"
