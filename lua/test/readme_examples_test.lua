...
local SDK_MODULE = "world-cup-qualification_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["competition"] = { ["test01"] = { id = "test01" } }, ["match"] = { ["test01"] = { id = "test01" } }, ["standing"] = { ["test01"] = { id = "test01" } }, ["team"] = { ["test01"] = { id = "test01" } } } }'
