...
describe("TeamEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set WORLD_CUP_QUALIFICATION_TEST_TEAM_ENTID JSON to run live")
      return
    end
...
function team_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("WORLD_CUP_QUALIFICATION_TEST_TEAM_ENTID")
  ...
  local idmap_resolved = helpers.to_map(
    env["WORLD_CUP_QUALIFICATION_TEST_TEAM_ENTID"])
